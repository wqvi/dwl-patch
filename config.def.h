...
static const char *const autostart[] = {
	...
	"/usr/bin/dbus-launch", "--exit-with-session", "foot", "--server", NULL,
...
static const MonitorRule monrules[] = {
	...
	{ NULL,       0.55f, 1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  0 },
};
...
static const Key keys[] = {
	...
	{ 0, XKB_KEY_XF86MonBrightnessUp, spawn, {.v = backlightincrease } },
	{ 0, XKB_KEY_XF86MonBrightnessDown, spawn, {.v = backlightdecrease } },
	{ 0, XKB_KEY_XF86AudioRaiseVolume, spawn, {.v = volumeincrease } },
	{ 0, XKB_KEY_XF86AudioMute, spawn, {.v = volumemute } },
	{ 0, XKB_KEY_XF86AudioLowerVolume, spawn, {.v = volumedecrease } },
